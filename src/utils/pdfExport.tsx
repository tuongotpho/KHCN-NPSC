...
Font.register({
    ...
    fonts: [
        ...
        { src: 'https://fonts.gstatic.com/s/roboto/v20/KFOlCnqEu92Fr1MmEU9vAwcg4A.ttf', fontWeight: 'medium' },
        { src: 'https://fonts.gstatic.com/s/roboto/v20/KFOlCnqEu92Fr1MmWUlvAwcg4A.ttf', fontWeight: 'bold' }
    ]
});
